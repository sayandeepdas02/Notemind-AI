            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                <div className="mx-auto max-w-4xl text-center">
                    <h1 className="text-5xl font-serif font-medium tracking-tight text-gray-900 sm:text-7xl mb-8 leading-[1.1]">
                        AI Agents that automate <br className="hidden sm:block" /> modern workflows
                    </h1>
                    <p className="mt-8 text-xl leading-8 text-gray-600 font-sans max-w-2xl mx-auto">
                        Notemind handles tasks like meeting notes, summaries, and scheduling so you don't have to.
                    </p>
                ...
                <div className="mt-24 text-center">
                    <p className="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-8">Trusted by 500+ companies worldwide</p>
